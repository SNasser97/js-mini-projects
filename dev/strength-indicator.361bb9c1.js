...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"password-strength-indicator/strength-indicator.js":[function(require,module,exports) {
var $ = document.querySelector.bind(document);
var progressBar = $('#js-progressbar');
var passwordField = $('#password');

var validatePassword = function validatePassword(value) {
  var string = value.trim().split('');
  var cases = {
    hasLength: false,
    hasUpper: false,
    hasNumber: false,
  ...
  string.forEach(function (char) {
    if (typeof Number(char) === 'number' && !isNaN(char)) {
      ...
      var re = /[-!$@%^=_]/; // @ == uppercase => true, we reset to false
...
var displayProgress = function displayProgress(cases) {
  progressBar.classList.add('js-show');
  var num = Object.values(cases).reduce(function (prev, acc) {
    return prev + acc;
  }, 0);
...
var displayMessage = function displayMessage() {
  var res = progressBar.value; // no need to add break, as we return the msg
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","password-strength-indicator/strength-indicator.js"], null)
//# sourceMappingURL=/strength-indicator.361bb9c1.js.map